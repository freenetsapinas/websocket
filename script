...
wget --no-check-certificate -O /etc/ssl/socks.py https://raw.githubusercontent.com/freenetsapinas/websocket/main/444.py -q
wget --no-check-certificate -O /etc/ssl/socks2.py https://raw.githubusercontent.com/freenetsapinas/websocket/main/441.py -q
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/websocket/main/auth_prem.sh -q
